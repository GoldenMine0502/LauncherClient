...
import kr.goldenmine.inuminecraftlauncher.ui.ClientInfo;
...
//    private static final String TECHNIC_CLIENT_ID = "8dfabc1d-38a9-42d8-bc08-677dbc60fe65";
    private static final String INU_LAUNCHER_CLIENT_ID;
    private static final String INU_LAUNCHER_CLIENT_SECRET;
...
//                    BufferedReader(InputStreamReader(Objects.requireNonNull(javaClass.classLoader.getResourceAsStream("client.json"))))
            ...
            ClientInfo clientInfo = new Gson().fromJson(is, type);
            INU_LAUNCHER_CLIENT_ID = clientInfo.getClientId();
            INU_LAUNCHER_CLIENT_SECRET = clientInfo.getClientSecret();
        } catch (IOException e) {
...
//        });
    ...
    private Credential getOAuthCredential(String username) throws MicrosoftAuthException {
        LocalServerReceiver receiver = new LocalServerReceiver.Builder()
                .setHost("localhost").setPort(20200).setCallbackPath("/").build();
    ...
    private AuthorizationCodeFlow buildFlow() throws IOException {
        return new AuthorizationCodeFlow.Builder(
                        ...
                        new ClientParametersAuthentication(INU_LAUNCHER_CLIENT_ID, INU_LAUNCHER_CLIENT_SECRET),
                INU_LAUNCHER_CLIENT_ID,
